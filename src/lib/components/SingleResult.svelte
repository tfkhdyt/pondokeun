...
<div
	...
	<div class="flex flex-col gap-4 justify-between items-center w-full md:flex-row">
		<div class="flex justify-between items-start w-full md:items-center md:w-5/6">
			<div class="w-8/12 font-medium break-words md:w-9/12 md:break-all line-clamp-2" title={link}>
				{link}
			</div>
