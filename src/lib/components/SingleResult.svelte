...
<div
	class="flex flex-col gap-4 justify-between items-center p-4 text-sm text-blue-800 bg-blue-50 rounded-lg md:flex-row dark:text-blue-400 dark:bg-gray-800"
	role="alert"
>
